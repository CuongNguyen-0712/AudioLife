...
public static class SampleData
{
    public static List<Category> GetCategories()
    {
        ...
        {
            new() { Id = "1", Name = "Di tích lịch sử", Icon = "fa-landmark", Description = "Các di tích lịch sử, văn hóa quan trọng" },
            new() { Id = "2", Name = "Bảo tàng", Icon = "fa-building-columns", Description = "Các bảo tàng trưng bày hiện vật" },
            new() { Id = "3", Name = "Chùa chiền", Icon = "fa-place-of-worship", Description = "Các ngôi chùa cổ kính" },
            new() { Id = "4", Name = "Công viên", Icon = "fa-tree", Description = "Công viên và khu vui chơi" },
            new() { Id = "5", Name = "Làng nghề", Icon = "fa-palette", Description = "Các làng nghề truyền thống" },
            new() { Id = "6", Name = "Ẩm thực", Icon = "fa-utensils", Description = "Điểm ẩm thực đặc sản" }
        };
    }
    ...
    public static List<Location> GetLocations()
    {
        return new List<Location>
        {
            new()
            {
                ...
                ImageUrl = "/images/locations/chua_mot_cot.jpg",
            ...
            new()
            {
                ...
                ImageUrl = "/images/locations/van_mieu.jpg",
            ...
            new()
            {
                ...
                ImageUrl = "/images/locations/hoang_thanh.jpg",
            ...
            new()
            {
                ...
                ImageUrl = "/images/locations/lang_bac.jpg",
            ...
            new()
            {
                ...
                ImageUrl = "/images/locations/hoa_lo.jpg",
            ...
            new()
            {
                ...
                ImageUrl = "/images/locations/ho_guom.jpg",
            ...
            new()
            {
                ...
                ImageUrl = "/images/locations/bao_tang_dan_toc.jpg",
            ...
            new()
            {
                ...
                ImageUrl = "/images/locations/chua_tran_quoc.jpg",
            ...
            new()
            {
                ...
                ImageUrl = "/images/locations/pho_co.jpg",
            ...
            new()
            {
                ...
                ImageUrl = "/images/locations/bat_trang.jpg",
    ...
    private static List<AudioGuide> GetChuaMotCotAudioGuides()
    {
    ...
    private static List<AudioGuide> GetVanMieuAudioGuides()
    {
        return new List<AudioGuide>
        {
    ...
    private static List<AudioGuide> GetHoangThanhAudioGuides()
    {
        return new List<AudioGuide>
        {
    ...
    private static List<AudioGuide> GetLangBacAudioGuides()
    {
        return new List<AudioGuide>
        {
    ...
    private static List<AudioGuide> GetHoaLoAudioGuides()
    {
        return new List<AudioGuide>
        {
    ...
    private static List<AudioGuide> GetHoGuomAudioGuides()
    {
        return new List<AudioGuide>
        {
    ...
    private static List<AudioGuide> GetBaoTangDanTocAudioGuides()
    {
        return new List<AudioGuide>
        {
    ...
    private static List<AudioGuide> GetChuaTranQuocAudioGuides()
    {
        return new List<AudioGuide>
        {
    ...
    private static List<AudioGuide> GetPhoCoAudioGuides()
    {
        return new List<AudioGuide>
        {
    ...
    private static List<AudioGuide> GetBatTrangAudioGuides()
    {
        return new List<AudioGuide>
        {
    ...
    public static List<Tour> GetTours()
    {
        return new List<Tour>
        {
            new()
            {
                ...
                Description = "Khám phá những điểm đến nổi tiếng nhất Hà Nội trong một ngày. Tour bao gồm tham quan Văn Miếu - Quốc Tử Giám, Lăng Bác, Hồ Hoàn Kiếm và Chùa Một Cột.",
                ImageUrl = "/images/tours/tour_hanoi_oneday.jpg",
                Duration = 480,
            ...
            new()
            {
                Id = "tour_002",
                Name = "Di sản văn hóa",
                Description = "Hành trình qua các di sản văn hóa lịch sử quan trọng. Tham quan Hoàng Thành Thăng Long, Văn Miếu và Nhà tù Hỏa Lò.",
                ImageUrl = "/images/tours/tour_heritage.jpg",
                Duration = 360,
            ...
            new()
            {
                ...
                Description = "Tham quan các ngôi chùa cổ kính trong thành phố. Khám phá Chùa Một Cột, Chùa Trấn Quốc và Hồ Hoàn Kiếm.",
                ImageUrl = "/images/tours/tour_spiritual.jpg",
                Duration = 240,
            ...
            new()
            {
                ...
                Description = "Khám phá làng gốm Bát Tràng và văn hóa thủ công truyền thống hơn 700 năm lịch sử.",
                ImageUrl = "/images/tours/tour_craft.jpg",
                Duration = 300,
